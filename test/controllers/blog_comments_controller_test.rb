...
class BlogCommentsControllerTest < ActionController::TestCase
  ...
  test "should create blog_comment" do
    assert_difference('BlogComment.count') do
      post :create, blog_comment: { blog_post_id: @blog_comment.blog_post_id, body: @blog_comment.body, user: @blog_comment.user }
    end
  ...
  test "should update blog_comment" do
    patch :update, id: @blog_comment, blog_comment: { blog_post_id: @blog_comment.blog_post_id, body: @blog_comment.body, user: @blog_comment.user }
    assert_redirected_to blog_comment_path(assigns(:blog_comment))
  end
